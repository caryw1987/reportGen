...
<script type="text/javascript">
	...
	function findImage()
	{
		...
		var param ={wordAttrMasterSampleNo:masterSampleNo};
			...
			<div class="content-box" style="width:1060px;">
				...
				<div class="content-box-content">
					<form enctype="multipart/form-data"
						action="reportAction_generateReport.action"
						method="post">
						<input type="hidden" id="report.puid" name="report.puid" value="<s:property value="report.puid"/>"  />
						<input type="hidden" id="masterSampleNo" name="report.masterSampleNo" value="<s:property value="report.masterSampleNo"/>"  />
<!-- 						<p> -->
<!-- 							Technical Report: -->
<!-- 							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
...
<!-- 						</p> -->
						<p>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="text-input small-input" type="text"
								name="report.dateIn" value="<s:property value="report.dateIn.substring(0,4)" />-<s:property
											value="report.dateIn.substring(4,6)" />-<s:property
											value="report.dateIn.substring(6,8)" />" /> &nbsp;&nbsp;&nbsp;format yyyy-mm-dd
						</p>
                        <p>
							Date Modify:
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<p>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="text-input small-input" type="text"
								name="report.specialItem" value="<s:property value="report.specialItem"/>"/>
						</p>
						<p>
							PO No.:
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="text-input small-input" type="text"
								name="report.poNo" value="<s:property value="report.poNo"/>" />
						</p>
						<p>
							Vendor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="text-input small-input" type="text"
								name="report.vendor" value="<s:property value="report.vendor"/>" />
						</p>
						<p>
							Factory/Manufacturer: &nbsp;<input class="text-input small-input"
								...
								<td id="tsTd">
									<div>
										<p id="p1">
											...
											Lead:<input id="1" class="text-input little-input" type="text" name="wordAttrLead" value="<10.0" />
											Cadmium:<input id="1" class="text-input little-input" type="text" name="wordAttrCadmium" value="3.0" /> 
