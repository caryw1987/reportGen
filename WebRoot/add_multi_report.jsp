		...
		<div id="main-content">
			...
			<div class="content-box" >
				...
				<div class="content-box-header">
					<h3>Add Multiple Reports</h3>
				</div>
				<!-- End .content-box-header -->
				<div class="content-box-content">
					<form enctype="multipart/form-data"
						action="reportAction_addMultiReport.action?currentPage=1&pageSize=100"
						method="post">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MASTER SAMPLE NO: 
						<p>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<textarea class="text-input small-input" rows="20" name="multiMasterSampleNo">
							</textarea>
						</p>
						<p>
