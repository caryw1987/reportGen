          ...
          <table>
                  	    ...
                  	    <s:bean name= "org.apache.struts2.util.Counter"  id= "counter1" >
                        	...
                        	<s:iterator>
                        		<s:if test="%{pageBean.currentPage==current-1}">
                        		    <a href="reportAction_listReportsByPage.action?currentPage=<s:property value="current-1"/>&pageSize=<s:property value="pageBean.pageSize"/>" ><font color="red">[<s:property value="current-1"/>]</font></a>
                        		</s:if>
                        		<s:else>
                        		    <a href="reportAction_listReportsByPage.action?currentPage=<s:property value="current-1"/>&pageSize=<s:property value="pageBean.pageSize"/>" >[<s:property value="current-1"/>]</a>
                        		</s:else>
                            </s:iterator>
                        </s:bean>
                  	</s:if>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                	<s:property value="#report.generateStartTime.substring(0,4)" />-<s:property value="#report.generateStartTime.substring(4,6)" />-<s:property value="#report.generateStartTime.substring(6,8)" />
                </td>
                <td>
                	<s:property value="#report.generateEndTime.substring(0,4)" />-<s:property value="#report.generateEndTime.substring(4,6)" />-<s:property value="#report.generateEndTime.substring(6,8)" />
                <td>
